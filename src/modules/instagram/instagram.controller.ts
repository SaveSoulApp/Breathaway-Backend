...
export class InstagramController extends BaseController {
   ...
   * @throws {HttpException} When the Graph API rejects the token (e.g., token is invalid
   ...
   * @throws {InternalServerErrorException} When `INSTAGRAM_ACCESS_TOKEN` is absent
